...
<body>
	...
	<br>
	<%--<form:form id="searchForm" modelAttribute="cloth" action="${adminPath}/erm/cloth/" method="post" class="form-horizontal">--%>
		...
		<%--<div class="form-group">--%>
			...
			<%--<button class="btn btn-success" type="submit">--%>
				...
				<%--查询--%>
			<%--</button>--%>
			<%--&lt;%&ndash;<a href="${adminPath}/erm/cloth/createSalary">&ndash;%&gt;--%>
					<%--&lt;%&ndash;生成工资&ndash;%&gt;--%>
			<%--&lt;%&ndash;</a>&ndash;%&gt;--%>
		<%--</div>--%>
	<%--</form:form>--%>
